...
do     
    ...
    python /kaggle/working/AUW-GCN-test/train.py --dataset $DATASET --output $OUTPUT --subject ${i}  # for training
    python /kaggle/working/AUW-GCN-test/eval.py --dataset $DATASET --output $OUTPUT --subject ${i}   # for evaluation
done
